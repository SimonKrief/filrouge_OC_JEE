		...
		<form
			...
			<fieldset>
				...
				<br /> <label for="montantCommande">Montant <span
					...
					value="<c:out value="${commande.montant}"/>"
					size="30"
					maxlength="30" /> <span class="erreur">${form.erreurs['montantCommande']}</span>
				<br /> <label for="modePaiementCommande">Mode de paiement <span
					class="requis">*</span></label> <input
					type="text"
					id="modePaiementCommande"
				...
				<br /> <label for="statutPaiementCommande">Statut du
					...
					type="text"
					id="statutPaiementCommande"
					name="statutPaiementCommande"
					value="<c:out value="${commande.statutPaiement}"/>"
					size="30"
				...
				<br /> <label for="modeLivraisonCommande">Mode de livraison
					...
					type="text"
					id="modeLivraisonCommande"
					name="modeLivraisonCommande"
					value="<c:out value="${commande.modeLivraison}"/>"
					size="30"
				...
				<br /> <label for="statutLivraisonCommande">Statut de la
					...
					type="text"
					id="statutLivraisonCommande"
					name="statutLivraisonCommande"
					value="<c:out value="${commande.statutLivraison}"/>"
					size="30"
